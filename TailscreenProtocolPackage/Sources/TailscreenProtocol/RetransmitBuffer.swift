...
public final class RetransmitBuffer: @unchecked Sendable {
    ...
    public func recordViewerRange(addr: String, startSeq: UInt16, count: UInt16, batchID: UInt64) {
    ...
    public func removeViewer(addr: String) {
    ...
    public struct BudgetState: Equatable {
        ...
        public init(tokens: Double, lastRefillNs: UInt64) {
            self.tokens = tokens
            self.lastRefillNs = lastRefillNs
        }
    }
    ...
    public struct BudgetConfig: Equatable {
        ...
        public init(tokensPerSecond: Double, maxTokens: Double) {
