...
enum ReceiveLoopPolicy {
    ...
    static let maxErrorsPerWindow = 30

    /// Trailing window for `maxErrorsPerWindow`.
    static let errorWindowNs: UInt64 = 60_000_000_000
    ...
    static let readFailedErrorMaxElapsedNs: UInt64 = 200_000_000
    ...
    static func classifyReadFailedAsError(elapsedNs: UInt64) -> Bool {
    ...
    static func slidingWindowErrorCount(
