...
enum RemoteControlPolicy {
    ...
    static func shouldInject(grant: ControlGrant?, connectionID: UUID) -> Bool {
    ...
    static func coalesceMouseMoves(_ events: [InputEvent]) -> [InputEvent] {
        var out: [InputEvent] = []
...
struct EventRateLimiter {
    ...
    init(maxEventsPerWindow: Int = 600, windowNs: UInt64 = 1_000_000_000) {
    ...
    mutating func allow(nowNs: UInt64) -> Bool {
