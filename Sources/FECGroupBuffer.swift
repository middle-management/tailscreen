...
struct FECGroupBuffer: Sendable {
    ...
    mutating func noteMedia(seq: UInt16, packet: Data, nowNs: UInt64) -> Recovery? {
        if held[seq] == nil {
            held[seq] = packet
    ...
    mutating func noteParity(baseSeq: UInt16, count: Int, body: Data, nowNs: UInt64) -> Recovery? {
