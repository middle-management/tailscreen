...
- **Caches are keyed on the matrix/arch dimension.** `libtailscale.a`,
  `Apps/windows/.build` and `Apps/linux-gtk/.build` all carry `runner.arch` (or
