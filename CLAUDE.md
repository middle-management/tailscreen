...
│   │                           #   libopus (Opus-only audio foundation; see its README)
...
**`TailscreenProtocolPackage/README.md`** — read it before touching the
